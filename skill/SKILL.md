...
RAG is paused for now. Do not use `rag-search` or `review --rag` unless the user explicitly asks to re-enable the optional RAG workflow.
...
```bash
cd /Users/riesenhuang/Desktop/zxpro/delaware-law-skill
```
